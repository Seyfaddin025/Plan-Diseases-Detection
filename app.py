...
@st.cache_resource
def load_model():
    return tf.keras.models.load_model(r'C:\Users\user\Desktop\Technofest Project\inceptionv3_model_finetuned.h5')

@st.cache_data
def load_class_labels():
    with open(r"C:\Users\user\Desktop\Technofest Project\class_labels.json", "r") as f:
        return json.load(f)
